...
import { addCandidateFunction, deleteCandidateFunction, getCandidateById, getManageCandidates, updateCandidateFunction, updateCandidateStatus } from "../controllers/candidate";
